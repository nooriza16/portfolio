...
1.  Performing linear regression on several X indicators, means that we need to check the multiple linear regression assumptions such as multicollinearity etc.
