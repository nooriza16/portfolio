...
Have you ever experienced using public transport, it does not operate the way you thought it would? You check upon your maps and voila diversion. Either you have to wait, which is unlikely, or change into other transports choice. What if those scenario happened in the most important node of transport, in a peak hour?

To make the impacts less destructive, we build a mitigation scenario, therefeore when there is a disruption in the most important station in the most critical hours we could provide alternatives for passengers without overwhelming the rest of the network. So how do we do this?
